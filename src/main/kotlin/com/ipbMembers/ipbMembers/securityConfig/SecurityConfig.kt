...
class SecurityConfig {
    ...
    fun userDetailsService(
        ...
        return UserDetails(userRepository, roleRepository)
    }
    ...
    @Bean
    fun authProvider(userRepository: IMemberRepository, roleRepository: IRoleRepository): AuthenticationProvider {
    ...
    fun securityFilter(
        ...
        http.csrf { it.disable() }.authorizeHttpRequests {
            it.requestMatchers("/auth", "auth/refresh")
                .permitAll()
                .anyRequest()
                .fullyAuthenticated()
        }.sessionManagement {
